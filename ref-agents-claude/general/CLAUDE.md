...
> Codex companion files are generated by `node scripts/sync-guide-files.mjs`.
> After editing this file, re-run the sync script to keep `AGENTS.md` aligned.
...
**BLOCKING REQUIREMENT:** Before writing ANY code in either portal directory, you MUST first read the portal-specific CLAUDE.md:
