import { Home, Building, Users, Megaphone, Building2, User, ArrowLeft, Heart } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const menuItems = [
  ...
  { title: "Tài sản quan tâm", path: "/broker/saved-assets", icon: Heart, description: "Đã lưu & theo dõi" },
